...
export class CheckoutPage {
  ...
  constructor(
    ...
    this.page = page;
    this.addressDelivery = page.getByText(
      `Your delivery address Mr. ${user.firstName} ${user.lastName} ${user.company} ${user.address} ${user.address2} ${user.city} ${user.state} ${user.zipcode} ${user.country} ${user.mobileNumber}`,
    );
    this.addressInvoice = page.getByText(
      `Your billing address Mr. ${user.firstName} ${user.lastName} ${user.company} ${user.address} ${user.address2} ${user.city} ${user.state} ${user.zipcode} ${user.country} ${user.mobileNumber}`,
    );
